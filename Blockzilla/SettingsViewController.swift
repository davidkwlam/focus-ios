...
class SettingsViewController: UIViewController, UITableViewDataSource, UITableViewDelegate {
    ...
    func tableView(_ tableView: UITableView, viewForFooterInSection section: Int) -> UIView? {
        if section == 4 {
            ...
            let subtitle = NSMutableAttributedString(string: UIConstants.strings.detailTextSendUsageData, attributes: [NSForegroundColorAttributeName : UIConstants.colors.settingsTextLabel])
